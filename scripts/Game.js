...
<<<<<<< Updated upstream
      ...
      basicZombie = this.physics.add.sprite(
        center.x - 100,
        center.y - 100,
        "zombiebasic"
      );
...
//     if (randomDirection == 0) {
//         let newZombie = zombies.create(randomPosX, positions.topEdge - distanceFromEdge, "zombiebasic").setScale(0.65);
//         newZombie.anims.play("zombiebasic");
//     } else if (randomDirection == 1) {
//         let newZombie = zombies.create(positions.rightEdge + distanceFromEdge, randomPosY, "zombiebasic").setScale(0.65);
//         newZombie.anims.play("zombiebasic");
//     } else if (randomDirection == 2) {
//         let newZombie = zombies.create(randomPosX, positions.bottomEdge + distanceFromEdge, "zombiebasic").setScale(0.65);
//         newZombie.anims.play("zombiebasic");
//     } else if (randomDirection == 3) {
//         let newZombie = zombies.create(positions.leftEdge - distanceFromEdge, randomPosY, "zombiebasic").setScale(0.65);
//         newZombie.anims.play("zombiebasic");
//     }
// }
>>>>>>> Stashed changes
